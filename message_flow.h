...
int update_specific_characteristics(ThreadArg *args, int number_choosen, int letter_chosen,int numerical_walues, char *filepath, char * options_after_wrong_input);
